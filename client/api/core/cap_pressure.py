...
class CapPressurePaths(object):
    ...
    GET_VERSION = "/capillarypressuretests/{record_id}/versions/{version}"
    DELETE = "/capillarypressuretests/{record_id}"
    POST_DATA = "/capillarypressuretests/{record_id}/data"
    GET_DATA = "/capillarypressuretests/{record_id}/data/{dataset_id}"


class CapPressureCore(APIResource, APIClient):
    ...
    def post_measurements(
        ...
        **kwargs,
        ...
        return self.post(
            path=CapPressurePaths.POST_DATA.format(record_id=record_id), json=body, **kwargs,
        ).json()
    ...
    def get_measurements(
        ...
        **kwargs,
        ...
        if schema_version_header:
            ...
            kwargs["headers"] = headers
        return self.get(
            path=CapPressurePaths.GET_DATA.format(record_id=record_id, dataset_id=dataset_id), **kwargs,
        ).json()
