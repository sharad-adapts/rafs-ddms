...
class ITPaths(object):
    ...
    GET_VERSION = "/interfacialtensiontests/{record_id}/versions/{version}"
    DELETE = "/interfacialtensiontests/{record_id}"
    POST_DATA = "/interfacialtensiontests/{record_id}/data"
    GET_DATA = "/interfacialtensiontests/{record_id}/data/{dataset_id}"


class InterfacialTensionCore(APIResource, APIClient):
    ...
    def post_measurements(
        ...
        **kwargs,
        ...
        return self.post(
            path=ITPaths.POST_DATA.format(record_id=record_id), json=body, **kwargs,
        ).json()
    ...
    def get_measurements(
        ...
        **kwargs,
        ...
        if schema_version_header:
            ...
            kwargs["headers"] = headers
        return self.get(
            path=ITPaths.GET_DATA.format(record_id=record_id, dataset_id=dataset_id), **kwargs,
        ).json()
