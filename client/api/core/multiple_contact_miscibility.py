...
class MCMPaths(object):
    ...
    GET_VERSION = "/multiplecontactmiscibilitytests/{record_id}/versions/{version}"
    DELETE = "/multiplecontactmiscibilitytests/{record_id}"
    POST_DATA = "/multiplecontactmiscibilitytests/{record_id}/data"
    GET_DATA = "/multiplecontactmiscibilitytests/{record_id}/data/{dataset_id}"


class MultipleContactMiscibilityCore(APIResource, APIClient):
    ...
    def post_measurements(
        ...
        **kwargs,
        ...
        return self.post(
            path=MCMPaths.POST_DATA.format(record_id=record_id), json=body, **kwargs,
        ).json()
    ...
    def get_measurements(
        ...
        **kwargs,
        ...
        if schema_version_header:
            ...
            kwargs["headers"] = headers
        return self.get(
            path=MCMPaths.GET_DATA.format(record_id=record_id, dataset_id=dataset_id), **kwargs,
        ).json()
