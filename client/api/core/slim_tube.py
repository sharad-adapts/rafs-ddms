...
class SlimTubePaths(object):
    ...
    GET_VERSION = "/slimtubetests/{record_id}/versions/{version}"
    DELETE = "/slimtubetests/{record_id}"
    POST_DATA = "/slimtubetests/{record_id}/data"
    GET_DATA = "/slimtubetests/{record_id}/data/{dataset_id}"


class SlimTubeCore(APIResource, APIClient):
    ...
    def post_measurements(
        ...
        **kwargs,
        ...
        return self.post(
            path=SlimTubePaths.POST_DATA.format(record_id=record_id), json=body, **kwargs,
        ).json()
    ...
    def get_measurements(
        ...
        **kwargs,
        ...
        if schema_version_header:
            ...
            kwargs["headers"] = headers
        return self.get(
            path=SlimTubePaths.GET_DATA.format(record_id=record_id, dataset_id=dataset_id), **kwargs,
        ).json()
