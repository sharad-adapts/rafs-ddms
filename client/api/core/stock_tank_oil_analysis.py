...
class STOAPaths(object):
    ...
    GET_VERSION = "/stocktankoilanalysisreports/{record_id}/versions/{version}"
    DELETE = "/stocktankoilanalysisreports/{record_id}"
    POST_DATA = "/stocktankoilanalysisreports/{record_id}/data"
    GET_DATA = "/stocktankoilanalysisreports/{record_id}/data/{dataset_id}"


class StockTankOilAnalysisCore(APIResource, APIClient):
    ...
    def post_measurements(
        ...
        **kwargs,
        ...
        return self.post(
            path=STOAPaths.POST_DATA.format(record_id=record_id), json=body, **kwargs,
        ).json()
    ...
    def get_measurements(
        ...
        **kwargs,
        ...
        if schema_version_header:
            ...
            kwargs["headers"] = headers
        return self.get(
            path=STOAPaths.GET_DATA.format(record_id=record_id, dataset_id=dataset_id), **kwargs,
        ).json()
