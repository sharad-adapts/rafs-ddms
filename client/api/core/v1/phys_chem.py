...
class PhysChemPaths(object):
    ...
    GET_VERSION = "/physicalchemistrytests/{record_id}/versions/{version}"
    DELETE = "/physicalchemistrytests/{record_id}"
    POST_DATA = "/physicalchemistrytests/{record_id}/data"
    GET_DATA = "/physicalchemistrytests/{record_id}/data/{dataset_id}"


class PhysChemCore(APIResource, APIClient):
    ...
    def post_measurements(
        ...
        **kwargs,
        ...
        return self.post(
            path=PhysChemPaths.POST_DATA.format(record_id=record_id), json=body, **kwargs,
        ).json()
    ...
    def get_measurements(
        ...
        **kwargs,
        ...
        if schema_version_header:
            ...
            kwargs["headers"] = headers
        return self.get(
            path=PhysChemPaths.GET_DATA.format(record_id=record_id, dataset_id=dataset_id), **kwargs,
        ).json()
