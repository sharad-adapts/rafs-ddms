...
class ExtractionPaths(object):
    ...
    GET_VERSION = "/extractiontests/{record_id}/versions/{version}"
    DELETE = "/extractiontests/{record_id}"
    POST_DATA = "/extractiontests/{record_id}/data"
    GET_DATA = "/extractiontests/{record_id}/data/{dataset_id}"


class ExtractionCore(APIResource, APIClient):
    ...
    def post_measurements(
        ...
        **kwargs,
        ...
        return self.post(
            path=ExtractionPaths.POST_DATA.format(record_id=record_id), json=body, **kwargs,
        ).json()
    ...
    def get_measurements(
        ...
        **kwargs,
        ...
        if schema_version_header:
            ...
            kwargs["headers"] = headers
        return self.get(
            path=ExtractionPaths.GET_DATA.format(record_id=record_id, dataset_id=dataset_id), **kwargs,
        ).json()
