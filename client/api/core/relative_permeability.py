...
class RelativePermeabilityPaths(object):
    ...
    GET_VERSION = "/relativepermeabilitytests/{record_id}/versions/{version}"
    DELETE = "/relativepermeabilitytests/{record_id}"
    POST_DATA = "/relativepermeabilitytests/{record_id}/data"
    GET_DATA = "/relativepermeabilitytests/{record_id}/data/{dataset_id}"


class RelativePermeabilityCore(APIResource, APIClient):
    ...
    def post_measurements(
        ...
        **kwargs,
        ...
        return self.post(
            path=RelativePermeabilityPaths.POST_DATA.format(record_id=record_id), json=body, **kwargs,
        ).json()
    ...
    def get_measurements(
        ...
        **kwargs,
        ...
        if schema_version_header:
            ...
            kwargs["headers"] = headers
        return self.get(
            path=RelativePermeabilityPaths.GET_DATA.format(record_id=record_id, dataset_id=dataset_id), **kwargs,
        ).json()
