...
class APIClient(object):
    ...
    def _handle_error_response(response, allowed_codes):
        ...
        raise AssertionError(f"{response_error}{response_body}")

    def _base_request(self, url: str, path: str, method: str, allowed_codes: List[int], **kwargs) -> requests.Response:
        """
        Universal API request sending
        :param url: full api url to send request
