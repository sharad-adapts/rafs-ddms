...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:extraction-123:1234"
TEST_DDMS_URN = f"urn://rafs-v1/extractiondata/partition:work-product-component--SamplesAnalysis:extraction_test/{TEST_DATASET_RECORD_ID}"
TEST_SCHEMA_VERSION = "1.0.0"
TEST_DDMS_URN_WITH_VERSION = f"urn://rafs-v1/extractiondata/partition:work-product-component--SamplesAnalysis:extraction_test/{TEST_DATASET_RECORD_ID}/{TEST_SCHEMA_VERSION}"
RECORD_DATA = {
...
with open(f"{dir_path}/extraction_test_data_orient_split.json") as fp:
