...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:relative-permeability-123:1234"
TEST_DDMS_URN = f"urn://rafs-v1/relativepermeabilitydata/partition:work-product-component--SamplesAnalysis:relative_permeability_test/{TEST_DATASET_RECORD_ID}"
TEST_SCHEMA_VERSION = "1.0.0"
TEST_DDMS_URN_WITH_VERSION = f"urn://rafs-v1/relativepermeabilitydata/partition:work-product-component--SamplesAnalysis:relative_permeability_test/{TEST_DATASET_RECORD_ID}/{TEST_SCHEMA_VERSION}"
RECORD_DATA = {
