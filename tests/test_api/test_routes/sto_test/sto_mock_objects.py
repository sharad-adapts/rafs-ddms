...
TEST_DDMS_URN_WITH_VERSION = f"urn://rafs-v1/stoanalysisdata/partition:work-product-component--StockTankOilAnalysisTest:sto_test/{TEST_DATASET_RECORD_ID}/{TEST_SCHEMA_VERSION}"
RECORD_DATA = {
