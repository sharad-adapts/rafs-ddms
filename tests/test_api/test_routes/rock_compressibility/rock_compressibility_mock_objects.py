...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:rock-compressibility-123:1234"
TEST_DDMS_URN = f"urn://rafs-v1/rockcompressibilitydata/partition:work-product-component--SamplesAnalysis:rock_compressibility_test/{TEST_DATASET_RECORD_ID}"
TEST_SCHEMA_VERSION = "1.0.0"
TEST_DDMS_URN_WITH_VERSION = f"urn://rafs-v1/rockcompressibilitydata/partition:work-product-component--SamplesAnalysis:rock_compressibility_test/{TEST_DATASET_RECORD_ID}/{TEST_SCHEMA_VERSION}"
RECORD_DATA = {
...
TEST_PARAMS_AGGREGATION = {
    "columns_aggregation": "CompressibilityTestSteps.0.ConfiningStress.Value,avg",
}
TEST_PARAMS_FILTERS = {
    "columns_filter": "SamplesAnalysisID,CompressibilityTestSteps",
    "rows_filter": "CompressibilityTestSteps.ConfiningStress.Value,gt,10",
}

with open(f"{dir_path}/rock_compressibility_orient_split.json") as fp:
    TEST_DATA = json.load(fp)

TEST_AGGREGATED_DATA = {
    "columns": [
        "avg(\"ApiGravity\".\"Value\")",
    ],
    "index": [
        0,
    ],
...
TEST_FILTERED_DATA = {
    ...
    "data": [
        [
            "opendes:work-product-component--SamplesAnalysis:PhysChemDevTest:",
            {
                "Value": 32.5,
