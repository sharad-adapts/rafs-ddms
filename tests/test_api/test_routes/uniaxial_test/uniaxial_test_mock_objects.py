...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:uniaxial_tests-123:1234"
TEST_DDMS_URN = f"urn://rafs-v2/uniaxialdata/{TEST_SAMPLESANALYSIS_ID}/{TEST_DATASET_RECORD_ID}"
TEST_SCHEMA_VERSION = "1.0.0"
TEST_DDMS_URN_WITH_VERSION = f"urn://rafs-v2/uniaxialdata/{TEST_SAMPLESANALYSIS_ID}/{TEST_DATASET_RECORD_ID}/{TEST_SCHEMA_VERSION}"
RECORD_DATA = {
...
TEST_PARAMS_FILTERS = {
    ...
    "rows_filter": "SamplesAnalysisID,eq,opendes:work-product-component--SamplesAnalysis:UniaxialTest123:",
}

with open(f"{dir_path}/uniaxial_test_orient_split.json") as fp:
...
TEST_FILTERED_DATA = {
    ...
    "data": [
        [
            "opendes:work-product-component--SamplesAnalysis:UniaxialTest123:",
        ],
    ],
}
