...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:gcmsratios-123:1234"
TEST_DDMS_URN = f"urn://rafs-v2/gcmsratiosdata/{TEST_SAMPLESANALYSIS_ID}/{TEST_DATASET_RECORD_ID}"
TEST_SCHEMA_VERSION = "1.0.0"
TEST_DDMS_URN_WITH_VERSION = f"urn://rafs-v2/gcmsratiosdata/{TEST_SAMPLESANALYSIS_ID}/{TEST_DATASET_RECORD_ID}/{TEST_SCHEMA_VERSION}"
RECORD_DATA = {
...
TEST_PARAMS_FILTERS = {
    ...
    "rows_filter": "SampleID,eq,opendes:master-data--Sample:GCMS_Sample:",
}

with open(f"{dir_path}/gcms_ratios_orient_split.json") as fp:
...
TEST_FILTERED_DATA = {
    ...
    "data": [
        [
            "opendes:work-product-component--SamplesAnalysis:GCMS_Ratios_Example:",
            "opendes:master-data--Sample:GCMS_Sample:",
        ],
    ],
}
