...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:formationresistivityindexes-123:1234"
TEST_DDMS_URN = f"urn://rafs-v1/formationresistivityindexdata/partition:work-product-component--SamplesAnalysis:formationresistivityindexes_test/{TEST_DATASET_RECORD_ID}"
TEST_SCHEMA_VERSION = "1.0.0"
TEST_DDMS_URN_WITH_VERSION = f"urn://rafs-v1/formationresistivityindexdata/partition:work-product-component--SamplesAnalysis:formationresistivityindexes_test/{TEST_DATASET_RECORD_ID}/{TEST_SCHEMA_VERSION}"
RECORD_DATA = {
...
TEST_PARAMS_AGGREGATION = {
    "columns_aggregation": "BrineSaturation.Value,sum",
}
TEST_PARAMS_FILTERS = {
    "columns_filter": "SamplesAnalysisID,BrineSaturation,ResistivityIndex",
    "rows_filter": "SamplesAnalysisID,eq,opendes:work-product-component--SamplesAnalysis:formationresistivityindexes-test:",
}

with open(f"{dir_path}/formationresistivityindex_test_data_orient_split.json") as fp:
