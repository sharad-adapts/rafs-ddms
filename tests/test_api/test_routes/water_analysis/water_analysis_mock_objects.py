...
TEST_DDMS_URN = f"urn://rafs-v1/wateranalysisdata/partition:work-product-component--WaterAnalysisTest:wateranalysis_test/{TEST_DATASET_RECORD_ID}"
TEST_SCHEMA_VERSION = "1.0.0"
TEST_DDMS_URN_WITH_VERSION = f"urn://rafs-v1/wateranalysisdata/partition:work-product-component--WaterAnalysisTest:wateranalysis_test/{TEST_DATASET_RECORD_ID}/{TEST_SCHEMA_VERSION}"
RECORD_DATA = {
...
TEST_PARAMS_FILTERS = {
    "columns_filter": "WaterAnalysisTestID,TestNumber,FluidSampleID",
    "rows_filter": "WaterAnalysisTestID,eq,opendes:work-product-component--WaterAnalysisTest:test:1",
}
...
TEST_FILTERED_DATA = {
    ...
    "data": [
        [
            "opendes:work-product-component--WaterAnalysisTest:test:1",
            "17. Water Analysis",
...
INCORRECT_SCHEMA_TEST_DATA = {
    ...
    "data": [
        [
            "opendes:work-product-component--WaterAnalysisTest:1:",
...
TEST_WRONG_ROWS_FILTERS = [
    ...
    {"rows_filter": "WaterAnalysisTestID,eq,wrong_pattern"},
]
TEST_WRONG_AGGREGATION = [
    {"columns_aggregation": "wrong_syntax"},
    {"columns_aggregation": "unvalid_column,avg"},
    {"columns_aggregation": "WaterAnalysisTestID,wrong_operator"},
]
