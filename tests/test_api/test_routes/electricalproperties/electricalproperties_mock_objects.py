...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:electricalproperties-123:1234"
TEST_DDMS_URN = f"urn://rafs-v1/electricalpropertiesdata/partition:work-product-component--SamplesAnalysis:electricalproperties_test/{TEST_DATASET_RECORD_ID}"
TEST_SCHEMA_VERSION = "1.0.0"
TEST_DDMS_URN_WITH_VERSION = f"urn://rafs-v1/electricalpropertiesdata/partition:work-product-component--SamplesAnalysis:electricalproperties_test/{TEST_DATASET_RECORD_ID}/{TEST_SCHEMA_VERSION}"
RECORD_DATA = {
...
TEST_PARAMS_AGGREGATION = {
    "columns_aggregation": "BrineConcentration.Value,sum",
}
TEST_PARAMS_FILTERS = {
    "columns_filter": "SamplesAnalysisID,BrineConcentration,FormationFactor",
    "rows_filter": "SamplesAnalysisID,eq,opendes:work-product-component--SamplesAnalysis:electricalproperties-test:",
}
