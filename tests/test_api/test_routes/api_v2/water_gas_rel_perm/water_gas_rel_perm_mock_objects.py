...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:watergasrelativepermeability-123:1234"
TEST_DDMS_URN = f"urn://rafs-v2/watergasrelativepermeabilitydata/partition:work-product-component--SamplesAnalysis:samplesanalysis_test/{TEST_DATASET_RECORD_ID}"
