...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:vaporliquidequilibrium-123:1234"
TEST_DDMS_URN = f"urn://rafs-v2/vaporliquidequilibriumdata/partition:work-product-component--SamplesAnalysis:samplesanalysis_test/{TEST_DATASET_RECORD_ID}"
...
with open(f"{dir_path}/vle_orient_split.json") as fp:
