...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:multiplesalinitytests-123:1234"
TEST_DDMS_URN = f"urn://rafs-v2/multiplesalinitytestsdata/{TEST_SAMPLESANALYSIS_ID}/{TEST_DATASET_RECORD_ID}"
TEST_SCHEMA_VERSION = "1.0.0"
TEST_DDMS_URN_WITH_VERSION = f"urn://rafs-v2/multiplesalinitytestsdata/{TEST_SAMPLESANALYSIS_ID}/{TEST_DATASET_RECORD_ID}/{TEST_SCHEMA_VERSION}"
RECORD_DATA = {
