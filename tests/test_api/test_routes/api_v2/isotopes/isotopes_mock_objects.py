...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:isotopes-123:1234"
TEST_DDMS_URN = f"urn://rafs-v2/isotopesdata/{TEST_SAMPLESANALYSIS_ID}/{TEST_DATASET_RECORD_ID}"
TEST_SCHEMA_VERSION = "1.0.0"
TEST_DDMS_URN_WITH_VERSION = f"urn://rafs-v2/isotopesdata/{TEST_SAMPLESANALYSIS_ID}/{TEST_DATASET_RECORD_ID}/{TEST_SCHEMA_VERSION}"
RECORD_DATA = {
...
TEST_FILTERED_DATA = {
    ...
    "data": [
        [
            "opendes:work-product-component--SamplesAnalysis:IsotopeAnalysis_WPC:",
            "opendes:master-data--Sample:IsotopeAnalysis_Sample:",
        ],
    ],
}
