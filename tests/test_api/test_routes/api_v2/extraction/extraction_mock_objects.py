...
TEST_DDMS_URN = f"urn://rafs-v2/extractiondata/partition:work-product-component--SamplesAnalysis:samplesanalysis_test/{TEST_DATASET_RECORD_ID}"
...
with open(f"{dir_path}/extraction_orient_split.json") as fp:
