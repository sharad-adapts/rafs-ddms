...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:crushedrockanalysis-123:1234"
TEST_DDMS_URN = f"urn://rafs-v2/crushedrockanalysisdata/partition:work-product-component--SamplesAnalysis:samplesanalysis_test/{TEST_DATASET_RECORD_ID}"
...
TEST_PARAMS_FILTERS = {
    ...
    "rows_filter": "SamplesAnalysisID,eq,opendes:work-product-component--SamplesAnalysis:SamplesAnalysis_Example:",
}

with open(f"{dir_path}/crushed_rock_analysis_orient_split.json") as fp:
...
TEST_FILTERED_DATA = {
    ...
    "data": [
        [
            "opendes:work-product-component--SamplesAnalysis:SamplesAnalysis_Example:",
        ],
    ],
}
...
INCORRECT_DATAFRAME_TEST_DATA["data"][0].pop()  # deleting Measurements in index row 0
