...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:swelling-123:1234"
TEST_DDMS_URN = f"urn://rafs-v2/swellingdata/partition:work-product-component--SamplesAnalysis:samplesanalysis_test/{TEST_DATASET_RECORD_ID}"
...
with open(f"{dir_path}/swelling_orient_split.json") as fp:
