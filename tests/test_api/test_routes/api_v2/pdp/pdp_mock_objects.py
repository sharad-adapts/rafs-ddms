...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:pdp-123:1234"
TEST_DDMS_URN = f"urn://rafs-v2/pdpdata/{TEST_SAMPLESANALYSIS_ID}/{TEST_DATASET_RECORD_ID}"
...
TEST_PARAMS_FILTERS = {
    ...
    "rows_filter": "SampleID,eq,opendes:master-data--Sample:PDP_Sample:",
}

with open(f"{dir_path}/pdp_orient_split.json") as fp:
...
TEST_FILTERED_DATA = {
    ...
    "data": [
        [
            "opendes:master-data--Sample:PDP_Sample:",
        ],
    ],
}
