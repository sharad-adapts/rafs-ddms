...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:transport-123:1234"
TEST_DDMS_URN = f"urn://rafs-v2/transportdata/partition:work-product-component--SamplesAnalysis:samplesanalysis_test/{TEST_DATASET_RECORD_ID}"
...
with open(f"{dir_path}/transport_test_orient_split.json") as fp:
...
INCORRECT_SCHEMA_TEST_DATA = {
    ...
    "data": [
        [
            "opendes:work-product-component--:samplesanalysis_test:1",
...
INCORRECT_DATAFRAME_TEST_DATA["data"][0].pop()  # deleting ViscosityTestSteps
