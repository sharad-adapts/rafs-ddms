...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:rockcompressibility-123:1234"
TEST_DDMS_URN = f"urn://rafs-v2/rockcompressibilitydata/partition:work-product-component--SamplesAnalysis:samplesanalysis_test/{TEST_DATASET_RECORD_ID}"
...
TEST_PARAMS_FILTERS = {
    ...
    "rows_filter": "SampleID,eq,opendes:master-data--Sample:4b:",
}
