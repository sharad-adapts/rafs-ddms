...
RCA_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.ROUTINECOREANALYSIS}"
NMR_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.NMR}"
MULTIPLE_SALINITY_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.MULTIPLE_SALINITY}"
GCMS_ALKANES_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.GCMS_ALKANES}"
MERCURY_INJECTION_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.MERCURY_INJECTION}"
GCMS_AROMATICS_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.GCMS_AROMATICS}"
GCMS_RATIOS_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.GCMS_RATIOS}"
GAS_CHROMATOGRAPHY_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.GAS_CHROMATOGRAPHY}"
GAS_COMPOSITION_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.GAS_COMPOSITION}"
ISOTOPE_ANALYSIS_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.ISOTOPE_ANALYSIS}"
BULK_PYROLYSIS_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.BULK_PYROLYSIS}"
CORE_GAMMA_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.CORE_GAMMA}"
UNIAXIAL_TEST_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.UNIAXIAL_TEST}"
GCMSMS_ANALYSIS_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.GCMSMS_ANALYSIS}"
CEC_CONTENT_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.CEC_CONTENT}"
ELECTRICAL_PROPERTIES_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.ELECTRICAL_PROPERTIES}"
TRIAXIAL_TEST_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.TRIAXIAL_TEST}"
CAP_PRESSURE_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.CAP_PRESSURE}"
WETTABILITY_INDEX_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.WETTABILITY_INDEXES}"
EDS_MAPPING_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.EDS_MAPPING}"
XRF_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.XRF}"
TENSILE_STRENGTH_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}{common_relative_paths_v2.TENSILE_STRENGTH}"
