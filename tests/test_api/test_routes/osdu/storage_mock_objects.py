...
BASE_DATA_V2_PATH = f"{SAMPLESANALYSIS_ENDPOINT_PATH}/{TEST_SAMPLESANALYSIS_ID}/data"
NMR_DATA_ENDPOINT_PATH = f"{BASE_DATA_V2_PATH}/nmrtests"
MULTIPLE_SALINITY_DATA_ENDPOINT_PATH = f"{BASE_DATA_V2_PATH}/multiplesalinitytests"
GCMS_ALKANES_DATA_ENDPOINT_PATH = f"{BASE_DATA_V2_PATH}/gcmsalkanes"
...
GAS_CHROMATOGRAPHY_DATA_ENDPOINT_PATH = f"{BASE_DATA_V2_PATH}/gaschromatographyanalyses"
GAS_COMPOSITION_DATA_ENDPOINT_PATH = f"{BASE_DATA_V2_PATH}/gascompositionanalyses"
ISOTOPE_ANALYSIS_DATA_ENDPOINT_PATH = f"{BASE_DATA_V2_PATH}/isotopes"
...
GCMSMS_ANALYSIS_DATA_ENDPOINT_PATH = f"{BASE_DATA_V2_PATH}/gcmsms"
CEC_CONTENT_ENDPOINT_PATH = f"{BASE_DATA_V2_PATH}/cec"
ELECTRICAL_PROPERTIES_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}/electricalproperties"
TRIAXIAL_TEST_DATA_ENDPOINT_PATH = f"{BASE_DATA_V2_PATH}/triaxial"
CAP_PRESSURE_DATA_ENDPOINT_PATH_API_V2 = f"{BASE_DATA_V2_PATH}/capillarypressure"
