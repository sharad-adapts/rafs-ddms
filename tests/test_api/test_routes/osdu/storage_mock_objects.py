...
SAMPLESANALYSIS_TYPES_ENDPOINT_PATH = f"{SAMPLESANALYSIS_ENDPOINT_PATH}/analysistypes"
...
class BulkDatasetId(NamedTuple):
    ...
    MULTIPLE_SALINITY = f"{PARTITION}:{FILE_GENERIC_TYPE}:multiple-salinity-test-{TEST_DATASET_UID}"
    MERCURY_INJECTION = f"{PARTITION}:{FILE_GENERIC_TYPE}:mercury-injection-analysis-{TEST_DATASET_UID}"
    GCMS_AROMATICS = f"{PARTITION}:{FILE_GENERIC_TYPE}:gcms-aromatics-test-{TEST_DATASET_UID}"
