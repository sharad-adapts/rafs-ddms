...
class TestContentPathsApiV2:
    RCA = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.ROUTINECOREANALYSIS}"
    CCE = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.CCE}"
    DIFF_LIB = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.DIFF_LIB}"
    TRANSPORT_TEST = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.TRANSPORT_TEST}"
    COMPOSITIONAL_ANALYSIS = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.COMPOSITIONAL_ANALYSIS}"
    MSS = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.MSS}"
    SWELLING = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.SWELLING}"
    CVD = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.CVD}"
    NMR = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.NMR}"
    MULTIPLE_SALINITY = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.MULTIPLE_SALINITY}"
    GCMS_ALKANES = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.GCMS_ALKANES}"
    MERCURY_INJECTION = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.MERCURY_INJECTION}"
    GCMS_AROMATICS = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.GCMS_AROMATICS}"
    GCMS_RATIOS = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.GCMS_RATIOS}"
    GAS_CHROMATOGRAPHY = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.GAS_CHROMATOGRAPHY}"
    GAS_COMPOSITION = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.GAS_COMPOSITION}"
    ISOTOPE_ANALYSIS = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.ISOTOPE_ANALYSIS}"
    BULK_PYROLYSIS = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.BULK_PYROLYSIS}"
    CORE_GAMMA = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.CORE_GAMMA}"
    UNIAXIAL_TEST = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.UNIAXIAL_TEST}"
    GCMSMS_ANALYSIS = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.GCMSMS_ANALYSIS}"
    CEC_CONTENT = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.CEC_CONTENT}"
    ELECTRICAL_PROPERTIES = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.ELECTRICAL_PROPERTIES}"
    TRIAXIAL_TEST = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.TRIAXIAL_TEST}"
    CAP_PRESSURE= f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.CAP_PRESSURE}"
    WETTABILITY_INDEX = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.WETTABILITY_INDEX}"
    EDS_MAPPING = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.EDS_MAPPING}"
    XRF = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.XRF}"
    TENSILE_STRENGTH = f"{BASE_DATA_V2_PATH}{commom_relative_paths_v2.TENSILE_STRENGTH}"
