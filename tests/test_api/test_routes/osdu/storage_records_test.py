...
@pytest.mark.parametrize(
    ...
    [
        ...
        (f"{API_VERSION}/capillarypressuretests", SAMPLESANALYSIS_RECORD, "DepthShiftsID"),
        (f"{API_VERSION}/relativepermeabilitytests", SAMPLESANALYSIS_RECORD, "DepthShiftsID"),
        (f"{API_VERSION}/fractionationtests", SAMPLESANALYSIS_RECORD, "DepthShiftsID"),
        (f"{API_VERSION}/extractiontests", SAMPLESANALYSIS_RECORD, "DepthShiftsID"),
        (f"{API_VERSION}/physicalchemistrytests", SAMPLESANALYSIS_RECORD, "DepthShiftsID"),
        (f"{API_VERSION}/electricalproperties", SAMPLESANALYSIS_RECORD, "DepthShiftsID"),
        (f"{API_VERSION}/rockcompressibilities", SAMPLESANALYSIS_RECORD, "DepthShiftsID"),
        (f"{API_VERSION}/watergasrelativepermeabilities", SAMPLESANALYSIS_RECORD, "DepthShiftsID"),
        (f"{API_VERSION}/formationresistivityindexes", SAMPLESANALYSIS_RECORD, "DepthShiftsID"),
        (f"{API_VERSION_V2}/samplesanalysesreport", storage_mock_objects.SAMPLESANALYSESREPORT_RECORD, "DocumentTypeID"),
        (f"{API_VERSION_V2}/samplesanalysis", storage_mock_objects.SAMPLESANALYSIS_RECORD, "DepthShiftsID"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("upsert_records", f"{API_VERSION_V2}/samplesanalysis", storage_mock_objects.SAMPLESANALYSIS_RECORD),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            f"{API_VERSION_V2}/samplesanalysis",
            storage_mock_objects.SAMPLESANALYSIS_RECORD,
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("get_record", f"{API_VERSION}/capillarypressuretests", SAMPLESANALYSIS_RECORD, TEST_SAMPLESANALYSIS_ID),
        ("get_record", f"{API_VERSION}/relativepermeabilitytests", SAMPLESANALYSIS_RECORD, TEST_SAMPLESANALYSIS_ID),
        ("get_record", f"{API_VERSION}/fractionationtests", SAMPLESANALYSIS_RECORD, TEST_SAMPLESANALYSIS_ID),
        ("get_record", f"{API_VERSION}/extractiontests", SAMPLESANALYSIS_RECORD, TEST_SAMPLESANALYSIS_ID),
        ("get_record", f"{API_VERSION}/physicalchemistrytests", SAMPLESANALYSIS_RECORD, TEST_SAMPLESANALYSIS_ID),
        ("get_record", f"{API_VERSION}/electricalproperties", SAMPLESANALYSIS_RECORD, TEST_SAMPLESANALYSIS_ID),
        ("get_record", f"{API_VERSION}/rockcompressibilities", SAMPLESANALYSIS_RECORD, TEST_SAMPLESANALYSIS_ID),
        (
            "get_record", f"{API_VERSION}/watergasrelativepermeabilities",
            SAMPLESANALYSIS_RECORD, TEST_SAMPLESANALYSIS_ID,
        ),
        ("get_record", f"{API_VERSION}/formationresistivityindexes", SAMPLESANALYSIS_RECORD, TEST_SAMPLESANALYSIS_ID),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "get_record", f"{API_VERSION_V2}/samplesanalysis", storage_mock_objects.SAMPLESANALYSIS_RECORD,
            storage_mock_objects.TEST_SAMPLESANALYSIS_ID,
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "upsert_records", status.HTTP_401_UNAUTHORIZED,
            f"{API_VERSION}/capillarypressuretests", SAMPLESANALYSIS_RECORD,
        ),
        (
            "upsert_records", status.HTTP_401_UNAUTHORIZED,
            f"{API_VERSION}/relativepermeabilitytests", SAMPLESANALYSIS_RECORD,
        ),
        ("upsert_records", status.HTTP_401_UNAUTHORIZED, f"{API_VERSION}/fractionationtests", SAMPLESANALYSIS_RECORD),
        (
            "upsert_records", status.HTTP_401_UNAUTHORIZED,
            f"{API_VERSION}/physicalchemistrytests", SAMPLESANALYSIS_RECORD,
        ),
        ("upsert_records", status.HTTP_401_UNAUTHORIZED, f"{API_VERSION}/electricalproperties", SAMPLESANALYSIS_RECORD),
        (
            "upsert_records", status.HTTP_401_UNAUTHORIZED,
            f"{API_VERSION}/rockcompressibilities", SAMPLESANALYSIS_RECORD,
        ),
        (
            "upsert_records", status.HTTP_401_UNAUTHORIZED,
            f"{API_VERSION}/watergasrelativepermeabilities", SAMPLESANALYSIS_RECORD,
        ),
        (
            "upsert_records", status.HTTP_401_UNAUTHORIZED,
            f"{API_VERSION}/formationresistivityindexes", SAMPLESANALYSIS_RECORD,
        ),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (f"{API_VERSION}/capillarypressuretests", SAMPLESANALYSIS_RECORD),
        (f"{API_VERSION}/relativepermeabilitytests", SAMPLESANALYSIS_RECORD),
        (f"{API_VERSION}/fractionationtests", SAMPLESANALYSIS_RECORD),
        (f"{API_VERSION}/extractiontests", SAMPLESANALYSIS_RECORD),
        (f"{API_VERSION}/physicalchemistrytests", SAMPLESANALYSIS_RECORD),
        (f"{API_VERSION}/electricalproperties", SAMPLESANALYSIS_RECORD),
        (f"{API_VERSION}/rockcompressibilities", SAMPLESANALYSIS_RECORD),
        (f"{API_VERSION}/watergasrelativepermeabilities", SAMPLESANALYSIS_RECORD),
        (f"{API_VERSION}/formationresistivityindexes", SAMPLESANALYSIS_RECORD),
        (f"{API_VERSION_V2}/samplesanalysesreport", storage_mock_objects.SAMPLESANALYSESREPORT_RECORD),
        (f"{API_VERSION_V2}/samplesanalysis", storage_mock_objects.SAMPLESANALYSIS_RECORD),
    ],
)
