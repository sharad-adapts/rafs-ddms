...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:physical-chemistry-123:1234"
TEST_DDMS_URN = f"urn://rafs-v1/physicalchemistrydata/partition:work-product-component--SamplesAnalysis:physchem_test/{TEST_DATASET_RECORD_ID}"
TEST_SCHEMA_VERSION = "1.0.0"
TEST_DDMS_URN_WITH_VERSION = f"urn://rafs-v1/physicalchemistrydata/partition:work-product-component--SamplesAnalysis:physchem_test/{TEST_DATASET_RECORD_ID}/{TEST_SCHEMA_VERSION}"
RECORD_DATA = {
...
TEST_PARAMS_AGGREGATION = {
    "columns_aggregation": "ApiGravity.Value,avg",
}
TEST_PARAMS_FILTERS = {
    "columns_filter": "SamplesAnalysisID,ApiGravity",
    "rows_filter": "ApiGravity.Value,gt,10",
}

with open(f"{dir_path}/physchem_orient_split.json") as fp:
