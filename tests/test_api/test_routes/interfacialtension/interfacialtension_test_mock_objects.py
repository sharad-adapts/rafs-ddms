...
TEST_DDMS_URN_WITH_VERSION = f"urn://rafs-v1/interfacialtensiondata/partition:work-product-component--InterfacialTensionTest:intefacialtension_test/{TEST_DATASET_RECORD_ID}/{TEST_SCHEMA_VERSION}"
RECORD_DATA = {
...
TEST_PARAMS_FILTERS = {
    "columns_filter": "InterfacialTensionTestID,TestNumber,FluidSampleID",
    "rows_filter": "InterfacialTensionTestID,eq,opendes:work-product-component--InterfacialTensionTest:test:1",
}
with open(f"{dir_path}/interfacialtension_test_data_orient_split.json") as fp:
...
TEST_FILTERED_DATA = {
    ...
    "data": [
        [
            "opendes:work-product-component--InterfacialTensionTest:test:1",
            "RFL 202002580",
...
INCORRECT_SCHEMA_TEST_DATA = {
    ...
    "data": [
        [
            "opendes:work-product-component--InterfacialTensionTest:1:",
...
TEST_WRONG_ROWS_FILTERS = [
    ...
    {"rows_filter": "InterfacialTensionTestID,eq,wrong_pattern"},
]
TEST_WRONG_AGGREGATION = [
    {"columns_aggregation": "wrong_syntax"},
    {"columns_aggregation": "unvalid_column,avg"},
    {"columns_aggregation": "InterfacialTensionTestID,wrong_operator"},
]
