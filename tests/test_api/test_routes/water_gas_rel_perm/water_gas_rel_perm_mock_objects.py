...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:water-gas-relative-permeability-123:1234"
TEST_DDMS_URN = f"urn://rafs-v1/watergasrelativepermeabilitydata/partition:work-product-component--SamplesAnalysis:watergasrelativepermeability_test/{TEST_DATASET_RECORD_ID}"
TEST_SCHEMA_VERSION = "1.0.0"
TEST_DDMS_URN_WITH_VERSION = f"urn://rafs-v1/watergasrelativepermeabilitydata/partition:work-product-component--SamplesAnalysis:watergasrelativepermeability_test/{TEST_DATASET_RECORD_ID}/{TEST_SCHEMA_VERSION}"
RECORD_DATA = {
...
TEST_PARAMS_FILTERS = {
    ...
    "rows_filter": "SampleID,eq,opendes:master-data--Sample:47a:",
}

with open(f"{dir_path}/water_gas_relative_permeability_orient_split.json") as fp:
...
TEST_FILTERED_DATA = {
    ...
    "data": [
        [
            "opendes:work-product-component--SamplesAnalysis:WaterGasRelativePermeabilityDevTest:",
