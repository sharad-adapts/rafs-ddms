...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:differential-liberation-123:1234"
TEST_DDMS_URN = f"urn://rafs-v1/differentialliberationdata/partition:work-product-component--DifferentialLiberationTest:dlt_test/{TEST_DATASET_RECORD_ID}"
TEST_SCHEMA_VERSION = "1.0.0"
TEST_DDMS_URN_WITH_VERSION = f"urn://rafs-v1/differentialliberationdata/partition:work-product-component--DifferentialLiberationTest:dlt_test/{TEST_DATASET_RECORD_ID}/{TEST_SCHEMA_VERSION}"
RECORD_DATA = {
...
TEST_PARAMS_FILTERS = {
    "columns_filter": "DifferentialLiberationTestID,TestNumber,FluidSampleID",
    "rows_filter": "DifferentialLiberationTestID,eq,opendes:work-product-component--DifferentialLiberationTest:dif_lib_test:",
}

with open(f"{dir_path}/dif_lib_orient_split.json") as fp:
...
TEST_FILTERED_DATA = {
    ...
    "data": [
        [
            "opendes:work-product-component--DifferentialLiberationTest:dif_lib_test:",
            "125",
...
INCORRECT_SCHEMA_TEST_DATA = {
    ...
    "data": [
        [
            "opendes:work-product-component--DifferentialLiberationTest:1:",
