...
@pytest.mark.parametrize(
    "data_endpoint_path,dataset_id", [
        (RCA_DATA_ENDPOINT_PATH, BulkDatasetIdV1.RCA),
        (CCE_DATA_ENDPOINT_PATH, BulkDatasetIdV1.CCE),
        (DIF_LIB_DATA_ENDPOINT_PATH, BulkDatasetIdV1.DIF_LIB),
        (TRANSPORT_DATA_ENDPOINT_PATH, BulkDatasetIdV1.TRANSPORT),
        (MSS_DATA_ENDPOINT_PATH, BulkDatasetIdV1.MSS),
        (COMPOSITIONALANALYSIS_DATA_ENDPOINT_PATH, BulkDatasetIdV1.CA),
        (SWELLING_DATA_ENDPOINT_PATH, BulkDatasetIdV1.SWELLING),
        (CVD_DATA_ENDPOINT_PATH, BulkDatasetIdV1.CVD),
        (STO_DATA_ENDPOINT_PATH, BulkDatasetIdV1.STO),
        (WATERANALYSIS_DATA_ENDPOINT_PATH, BulkDatasetIdV1.WA),
        (INTERFACIAL_TENSION_DATA_ENDPOINT_PATH, BulkDatasetIdV1.IT),
        (VLE_DATA_ENDPOINT_PATH, BulkDatasetIdV1.VLE),
        (MCM_DATA_ENDPOINT_PATH, BulkDatasetIdV1.MCM),
        (SLIMTUBE_DATA_ENDPOINT_PATH, BulkDatasetIdV1.SLIMTUBE),
        (RELATIVE_PERMEABILITY_DATA_ENDPOINT_PATH, BulkDatasetIdV1.RELATIVE_PERMEABILITY),
        (CAP_PRESSURE_DATA_ENDPOINT_PATH_API_V1, BulkDatasetIdV1.CAP_PRESSURE),
        (FRACTIONATION_DATA_ENDPOINT_PATH, BulkDatasetIdV1.FRACTIONATION),
        (EXTRACTION_DATA_ENDPOINT_PATH, BulkDatasetIdV1.EXTRACTION),
        (PHYS_CHEM_DATA_ENDPOINT_PATH, BulkDatasetIdV1.PHYS_CHEM),
        (WATER_GAS_REL_PERM_DATA_ENDPOINT_PATH, BulkDatasetIdV1.WATER_GAS_RELATIVE_PERMEABILITY),
        (ROCK_COMPRESSIBILITY_DATA_ENDPOINT_PATH, BulkDatasetIdV1.ROCK_COMPRESSIBILITY),
        (ELECTRICAL_PROPERTIES_DATA_ENDPOINT_PATH_API_V1, BulkDatasetIdV1.ELECTRICAL_PROPERTIES),
        (FORMATION_RESISTIVITY_INDEX_DATA_ENDPOINT_PATH, BulkDatasetIdV1.FORMATION_RESISTIVITY_INDEX),
    ],
)
@pytest.mark.asyncio
...
@pytest.mark.parametrize(
    "data_endpoint_path,params,returned_data_reasons", [
        ...
        (
            f"{CAP_PRESSURE_DATA_ENDPOINT_PATH_API_V1}/{cappressure_mock_objects.TEST_DATASET_RECORD_ID}",
...
@pytest.mark.parametrize(
    "data_endpoint_path, incorrect_schema_test_data", [
        ...
        (CAP_PRESSURE_DATA_ENDPOINT_PATH_API_V1, cappressure_mock_objects.INCORRECT_SCHEMA_TEST_DATA),
