...
TEST_DATASET_RECORD_ID = "opendes:dataset--File.Generic:swelling-test-123:1234"
TEST_DDMS_URN = f"urn://rafs-v1/swellingdata/partition:work-product-component--SwellingTest:swelling_test/{TEST_DATASET_RECORD_ID}"
TEST_SCHEMA_VERSION = "1.0.0"
TEST_DDMS_URN_WITH_VERSION = f"urn://rafs-v1/swellingdata/partition:work-product-component--SwellingTest:swelling_test/{TEST_DATASET_RECORD_ID}/{TEST_SCHEMA_VERSION}"
RECORD_DATA = {
...
TEST_PARAMS_FILTERS = {
    "columns_filter": "SwellingTestID,TestNumber,FluidSampleID",
    "rows_filter": "SwellingTestID,eq,opendes:work-product-component--SwellingTest:test:1",
}
with open(f"{dir_path}/swelling_test_data_orient_split.json") as fp:
...
TEST_FILTERED_DATA = {
    ...
    "data": [
        [
            "opendes:work-product-component--SwellingTest:test:1",
            "RFL 202002580",
...
INCORRECT_SCHEMA_TEST_DATA = {
    "columns": [
        ...
        "data",
        # "SwellingTestSteps",  # Missing mandatory field
    ],
    "index": [0],
    "data": [
        [
            "opendes:work-product-component--SwellingTest:1:",
...
INCORRECT_DATAFRAME_TEST_DATA["data"][0].pop()  # deleting SwellingTestSteps
...
TEST_WRONG_ROWS_FILTERS = [
    ...
    {"rows_filter": "SwellingTestID,eq,wrong_pattern"},
]
TEST_WRONG_AGGREGATION = [
    {"columns_aggregation": "wrong_syntax"},
    {"columns_aggregation": "unvalid_column,avg"},
    {"columns_aggregation": "SwellingTestID,wrong_operator"},
]
