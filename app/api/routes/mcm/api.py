...
from app.api.dependencies.validation import validate_mcm_records_payload
...
MCM_ID_REGEX_STR = r"^[\w\-\.]+:work-product-component--MultipleContactMiscibilityTest:[\w\-\.\:\%]+$"
...
StorageRecordViewWithLinking(
    router=mcm_router,
    id_regex_str=MCM_ID_REGEX_STR,
    validate_records_payload=validate_mcm_records_payload,
    record_type=RECORD_TYPE,
...
router.include_router(mcm_router, tags=["multiplecontactmiscibilitytests"], prefix="/multiplecontactmiscibilitytests")
