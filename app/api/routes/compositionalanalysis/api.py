...
from app.api.dependencies.validation import (
    validate_com_analysis_records_payload,
)
...
BaseDataView(
    router=ca_router,
    id_regex_str=COMPOSITIONALANALYSIS_ID_REGEX_STR,
    bulk_dataset_prefix="compositionalanalysis",
...
StorageRecordViewWithLinking(
    router=ca_router,
    id_regex_str=COMPOSITIONALANALYSIS_ID_REGEX_STR,
    validate_records_payload=validate_com_analysis_records_payload,
    record_type=RECORD_TYPE,
    child_id_field="PVTTests",
    parent_id_field="PVTReportID",
    parent_model=PVT,
)
router.include_router(ca_router, tags=["compositionalanalysisreports"], prefix="/compositionalanalysisreports")
