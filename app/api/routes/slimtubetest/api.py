...
from app.api.dependencies.validation import (
    validate_slimtubetest_records_payload,
)
...
SLIMTUBETEST_ID_REGEX_STR = r"^[\w\-\.]+:work-product-component--SlimTubeTest:[\w\-\.\:\%]+$"
...
BaseDataView(
    ...
    id_regex_str=SLIMTUBETEST_ID_REGEX_STR,
    bulk_dataset_prefix="slimtube-test",
...
StorageRecordViewWithLinking(
    router=slimtubetest_router,
    id_regex_str=SLIMTUBETEST_ID_REGEX_STR,
    validate_records_payload=validate_slimtubetest_records_payload,
    record_type=RECORD_TYPE,
...
router.include_router(slimtubetest_router, tags=["slimtubetests"], prefix="/slimtubetests")
