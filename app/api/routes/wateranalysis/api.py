...
from app.api.dependencies.validation import (
    validate_wateranalysis_records_payload,
)
...
BaseDataView(
    ...
    id_regex_str=WATERANALYSIS_ID_REGEX_STR,
    bulk_dataset_prefix="wateranalysis",
...
StorageRecordViewWithLinking(
    router=wateranalysis_router,
    id_regex_str=WATERANALYSIS_ID_REGEX_STR,
    validate_records_payload=validate_wateranalysis_records_payload,
    record_type=RECORD_TYPE,
...
router.include_router(wateranalysis_router, tags=["wateranalysisreports"], prefix="/wateranalysisreports")
