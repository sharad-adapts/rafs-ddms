...
from app.api.dependencies.validation import validate_mss_records_payload
...
BaseDataView(
    router=mss_router,
    id_regex_str=MSS_ID_REGEX_STR,
    bulk_dataset_prefix="multi-stage-separator",
...
StorageRecordViewWithLinking(
    router=mss_router,
    id_regex_str=MSS_ID_REGEX_STR,
    validate_records_payload=validate_mss_records_payload,
    record_type=RECORD_TYPE,
    child_id_field="PVTTests",
    parent_id_field="PVTReportID",
    parent_model=PVT,
)
router.include_router(mss_router, tags=["multistageseparatortests"], prefix="/multistageseparatortests")
