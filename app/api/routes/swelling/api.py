...
from app.api.dependencies.validation import validate_swelling_records_payload
...
BaseDataView(
    ...
    id_regex_str=SWELLING_ID_REGEX_STR,
    bulk_dataset_prefix="swelling",
...
StorageRecordViewWithLinking(
    router=swelling_test_router,
    id_regex_str=SWELLING_ID_REGEX_STR,
    validate_records_payload=validate_swelling_records_payload,
    record_type=RECORD_TYPE,
...
router.include_router(swelling_test_router, tags=["swellingtests"], prefix="/swellingtests")
