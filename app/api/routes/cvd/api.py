...
from app.api.dependencies.validation import validate_cvd_records_payload
...
BaseDataView(
    router=cvd_router,
    id_regex_str=CVD_ID_REGEX_STR,
    bulk_dataset_prefix="constantvolumedepletiontest",
...
StorageRecordViewWithLinking(
    router=cvd_router,
    id_regex_str=CVD_ID_REGEX_STR,
    validate_records_payload=validate_cvd_records_payload,
    record_type=RECORD_TYPE,
...
router.include_router(cvd_router, tags=["constantvolumedepletiontests"], prefix="/constantvolumedepletiontests")
