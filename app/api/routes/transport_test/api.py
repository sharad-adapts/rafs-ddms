...
from app.api.dependencies.validation import (
    validate_transport_test_records_payload,
)
...
BaseDataView(
    ...
    id_regex_str=TRANSPORT_TEST_ID_REGEX_STR,
    bulk_dataset_prefix="transport-test",
...
StorageRecordViewWithLinking(
    router=transport_test_router,
    id_regex_str=TRANSPORT_TEST_ID_REGEX_STR,
    validate_records_payload=validate_transport_test_records_payload,
    record_type=RECORD_TYPE,
...
router.include_router(transport_test_router, tags=["transporttests"], prefix="/transporttests")
