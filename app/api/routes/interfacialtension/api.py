...
from app.api.dependencies.validation import (
    validate_interfacialtension_records_payload,
)
...
BaseDataView(
    ...
    id_regex_str=INTERFACIAL_TENSION_ID_REGEX_STR,
    bulk_dataset_prefix="interfacialtension",
...
StorageRecordViewWithLinking(
    router=interfacialtension_router,
    id_regex_str=INTERFACIAL_TENSION_ID_REGEX_STR,
    validate_records_payload=validate_interfacialtension_records_payload,
    record_type=RECORD_TYPE,
