...
from app.api.dependencies.validation import validate_cce_records_payload
...
BaseDataView(
    router=cce_router,
    id_regex_str=CCE_ID_REGEX_STR,
    bulk_dataset_prefix="constant-composition-expansion",
...
StorageRecordViewWithLinking(
    router=cce_router,
    id_regex_str=CCE_ID_REGEX_STR,
    validate_records_payload=validate_cce_records_payload,
    record_type=RECORD_TYPE,
...
router.include_router(cce_router, tags=["ccereports"], prefix="/ccereports")
