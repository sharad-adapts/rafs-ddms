...
from app.api.dependencies.validation import validate_sto_records_payload
...
BaseDataView(
    router=sto_router,
    id_regex_str=STO_ID_REGEX_STR,
    bulk_dataset_prefix="stoanalysis",
...
StorageRecordViewWithLinking(
    router=sto_router,
    id_regex_str=STO_ID_REGEX_STR,
    validate_records_payload=validate_sto_records_payload,
    record_type=RECORD_TYPE,
...
router.include_router(sto_router, tags=["stocktankoilanalysisreports"], prefix="/stocktankoilanalysisreports")
