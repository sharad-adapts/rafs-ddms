...
class CommonRelativePaths(NamedTuple):
    ...
    COMPOSITIONAL_ANALYSIS = "/compositionalanalysisreports/"
    MSS = "/multistageseparatortests/"
    SWELLING = "/swellingtests/"
    CVD = "/constantvolumedepletiontests/"
    ...
    GAS_COMPOSITION = "data/gascompositionanalyses"
