...
#   filename:  /api/schema-service/v1/schema/rafsddms:wks:work-product-component--VaporLiquidEquilibriumTest:1.0.0
#   timestamp: 2023-05-15T09:20:06+00:00
...
class Data(Field0):
    DDMSDatasets: Optional[List[str]] = Field(
        None,
        description='URI link to the measurements which were carried out within this Vapor Liquid Equilibrium Test.',
        example=[
            'https://<vhostname>.<osdu-instance-fqdn>/api/rafs ddms/v1/CCE/get_CCE_data_record_id/45'
        ],
        title='Vapor Liquid Equilibrium Test Measurements',
    )
    PVTReportID: constr(
        regex=r'^[\w\-\.]+:work-product-component\-\-PVT:[\w\-\.\:\%]+:[0-9]*$'
    ) = Field(
        ...,
        description='Unique PVT identifier linked to this Vapor Liquid Equilibrium Test.',
        title='PVT Report ID',
    )
    ...
    AnalysisDate: Optional[date] = Field(
        None,
        description='The date the Vapor Liquid Equilibrium Test was performed.',
        title='Analysis Date',
    )
    Remarks: Optional[List[Remark]] = Field(
        None,
        description='An array containing operational or quality comments pertaining to a Vapor Liquid Equilibrium Test.',
    ...
    FluidSampleID: Optional[
        ...
        None,
        description='Unique ID of the Fluid which was analyzed by Vapor Liquid Equilibrium Test.',
        title='Fluid Sample ID',
    )


class VaporLiquidEquilibriumTest(BaseModel):
    class Config:
        extra = Extra.forbid
    ...
    kind: constr(regex=r'^[\w\-\.]+:[\w\-\.]+:[\w\-\.]+:[0-9]+.[0-9]+.[0-9]+$') = Field(
        ...
        example='rafsddms:wks:work-product-component--VaporLiquidEquilibriumTest:1.0.0',
        title='Entity Kind',
    )
    ...
    id: Optional[
        constr(
            regex=r'^[\w\-\.]+:work-product-component\-\-VaporLiquidEquilibriumTest:[\w\-\.\:\%]+$'
        )
    ] = Field(
        None,
        description='Previously called ResourceID or SRN which identifies this OSDU resource object without version.',
        example='namespace:work-product-component--VaporLiquidEquilibriumTest:dd76cf6c-226f-5636-ad1b-1ca0f8249cc8',
