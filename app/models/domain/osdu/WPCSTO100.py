...
#   filename:  /api/schema-service/v1/schema/rafsddms:wks:work-product-component--StockTankOilAnalysisTest:1.0.0
...
class Data(Field0):
    ...
    PVTReportID: constr(
        ...
        ...,
        description='Unique PVT identifier linked to this Stock Tank Oil Analysis.',
        title='PVT Report ID',
    )
    ...
    AnalysisDate: Optional[date] = Field(
        None, description='The date the Stock Tank Oil Analysis was performed.', title='Analysis Date'
    )
    ...
    FluidSampleID: Optional[
        ...
        None,
        description='Unique ID of the Fluid analyzed by Stock Tank Oil Analysis.',
