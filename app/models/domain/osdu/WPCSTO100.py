...
#   filename:  https://stable-{{osdu}}.centralus.cloudapp.azure.com/api/schema-service/v1/schema/rafsddms:wks:work-product-component--StockTankOilAnalysisTest:1.0.0
#   timestamp: 2023-05-01T14:26:58+00:00
...
class Data(Field0):
    DDMSDatasets: Optional[List[str]] = Field(
        None,
        description='URI link to the measurements which were carried out within this STO test.',
        example=[
            'https://<vhostname>.stable-{{osdu}}.centralus.cloudapp.azure.com/api/rafs ddms/v1/CCE/get_CCE_data_record_id/45'
        ],
        title='stock tank analysis test measurements',
    )
    PVTReportID: constr(
        regex=r'^[\w\-\.]+:work-product-component\-\-PVT:[\w\-\.\:\%]+:[0-9]*$'
    ) = Field(
        ...,
        description='Unique PVT identifier to which STO test is linked.',
        title='PVT Report ID',
    )
    ...
    AnalysisDate: Optional[date] = Field(
        None, description='The date the STO test was performed.', title='Analysis Date'
    )
    Remarks: Optional[List[Remark]] = Field(
        None,
        description='An array containing operational or quality comments pertaining to a STO test.',
    ...
    FluidSampleID: Optional[
        ...
        None,
        description='Unique ID of the Fluid Which was analyzed on STO test.',
        title='Fluid Sample ID',
    )


class StockTankOilAnalysisTest(BaseModel):
    class Config:
        extra = Extra.forbid
    ...
    kind: constr(regex=r'^[\w\-\.]+:[\w\-\.]+:[\w\-\.]+:[0-9]+.[0-9]+.[0-9]+$') = Field(
        ...
        example='rafsddms:wks:work-product-component--StockTankOilAnalysisTest:1.0.0',
        title='Entity Kind',
    )
    ...
    id: Optional[
        constr(
            regex=r'^[\w\-\.]+:work-product-component\-\-StockTankOilAnalysisTest:[\w\-\.\:\%]+$'
        )
    ] = Field(
        None,
        description='Previously called ResourceID or SRN which identifies this OSDU resource object without version.',
        example='namespace:work-product-component--StockTankOilAnalysisTest:dd76cf6c-226f-5636-ad1b-1ca0f8249cc8',
