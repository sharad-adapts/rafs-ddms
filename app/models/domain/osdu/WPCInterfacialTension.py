...
#   filename:  api/schema-service/v1/schema/rafsddms:wks:work-product-component--InterfacialTensionTest:1.0.0
#   timestamp: 2023-05-05T13:33:25+00:00
...
class Data(Field0):
    PVTReportID: Optional[
        ...
        None,
        description='Unique PVT identifier to which Interfacial Tension Test is linked.',
        title='PVT Report ID',
    )
    ...
    DDMSDataset: Optional[Any] = Field(
        None,
        description='URI link to the measurements which were carried out within this Interfacial Tension Test ID',
    ...
    AnalysisDate: Optional[date] = Field(
        None,
        description='The date the separator test was performed.',
        title='Analysis Date',
    )
    Remarks: Optional[List[Remark]] = Field(
        None,
        description='An array containing operational or quality comments pertaining to a multi stage separator test.',
    ...
    FluidSampleID: Optional[
        ...
        None,
        description='Unique ID of the Fluid Which was analyzed on separator test',
...
class InterfacialTensionTest(BaseModel):
    ...
    kind: constr(regex=r'^[\w\-\.]+:[\w\-\.]+:[\w\-\.]+:[0-9]+.[0-9]+.[0-9]+$') = Field(
        ...
        example='osdu:wks:work-product-component--InterfacialTensionTest:1.1.0',
        title='Entity Kind',
    )
    ...
    id: Optional[
        constr(
            regex=r'^[\w\-\.]+:work-product-component\-\-InterfacialTensionTest:[\w\-\.\:\%]+$'
        )
    ] = Field(
        None,
        description='Previously called ResourceID or SRN which identifies this OSDU resource object without version.',
        example='namespace:work-product-component--InterfacialTensionTestID:dd76cf6c-226f-5636-ad1b-1ca0f8249cc8',
        title='InterfacialTensionTestID',
    )
