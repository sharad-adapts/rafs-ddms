...
#   filename:  /api/schema-service/v1/schema/rafsddms:wks:work-product-component--MultiStageSeparatorTest:1.0.0
#   timestamp: 2023-04-13T06:21:39+00:00
...
class Data(Field0, Field0_1, Field0_2):
    DDMSDatasets: Optional[List[str]] = Field(
        ...
        title='MultiStageSeparatorTest DDMSDatasets',
    )
    PVTReportID: constr(
    ...
    AnalysisDate: Optional[date] = Field(
        None,
        description='The date the Multi Stage Separator Test was performed.',
        title='Analysis Date',
    )
    ...
    FluidSampleID: Optional[
        ...
        None,
        description='Unique ID of the Fluid which was analyzed by Multi Stage Separator.',
        title='Fluid Sample ID',
    )
    ExtensionProperties: Optional[Dict[str, Any]] = None


class MultiStageSeparatorTest(BaseModel):
    class Config:
        extra = Extra.forbid
    ...
    kind: constr(regex=r'^[\w\-\.]+:[\w\-\.]+:[\w\-\.]+:[0-9]+.[0-9]+.[0-9]+$') = Field(
        ...
        example='rafsddms:wks:work-product-component--MultiStageSeparatorTest:1.0.0',
        title='Entity Kind',
    )
    ...
    id: Optional[
        constr(
            regex=r'^[\w\-\.]+:work-product-component\-\-MultiStageSeparatorTest:[\w\-\.\:\%]+$'
        )
    ] = Field(
        None,
        description='Previously called ResourceID or SRN which identifies this OSDU resource object without version.',
        example='namespace:work-product-component--MultiStageSeparatorTest:dd76cf6c-226f-5636-ad1b-1ca0f8249cc8',
