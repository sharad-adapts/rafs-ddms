...
#   filename:  https://stable-{{osdu}}.centralus.cloudapp.azure.com/api/schema-service/v1/schema/rafsddms:wks:work-product-component--SwellingTest:1.0.0
...
class Data(Field0, Field0_1, Field0_2):
    ...
    AnalysisDate: Optional[date] = Field(
        None,
        description='The date the batch of SwellingTest test was performed.',
        title='Analysis Date',
    )
