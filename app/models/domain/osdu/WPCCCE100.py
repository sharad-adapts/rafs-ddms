...
#   filename:  https://stable-{{osdu}}.centralus.cloudapp.azure.com/api/schema-service/v1/schema/rafsddms:wks:work-product-component--ConstantCompositionExpansionTest:1.0.0
...
class Data(Field0):
    PVTReportID: constr(regex=r'^[\w\-\.]+:work-product\-component\-\-PVT:[\w\-\.\:\%]+:[0-9]*$') = Field(
        ...,
        description='Unique PVT identifier to which CCE is linked.',
        title='PVT Report ID',
    )
