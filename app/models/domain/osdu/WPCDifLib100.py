...
#   filename:  /api/schema-service/v1/schema/rafsddms:wks:work-product-component--DifferentialLiberationTest:1.0.0
...
class Data(Field0):
    PVTReportID: constr(regex=r'^[\w\-\.]+:work-product-component\-\-PVT:[\w\-\.\:\%]+:[0-9]*$') = Field(
        ...,
        description='Unique PVT identifier linked to this Differential Liberation.',
        title='PVT Report ID',
    )
    ...
    FluidSampleID: Optional[
        ...
        None,
        description='Unique ID of the Fluid which was analyzed by Differential Liberation',
