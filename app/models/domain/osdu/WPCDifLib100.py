...
#   filename:  https://stable-{{osdu}}.centralus.cloudapp.azure.com/api/schema-service/v1/schema/rafsddms:wks:work-product-component--DifferentialLiberationTest:1.0.0
#   timestamp: 2023-03-28T09:45:23+00:00
...
class Data(Field0):
    PVTReportID: constr(regex=r'^[\w\-\.]+:work-product-component\-\-PVT:[\w\-\.\:\%]+:[0-9]*$') = Field(
        ...,
        description='Unique PVT identifier to which differential liberation is linked.',
        title='PVT Report ID',
    )
    ...
    DDMSDataset: Optional[List[str]] = Field(
        None,
        description='URI link to the measurements which were carried out within this Differential Liberation.',
        example=[
            'https://<vhostname>.stable-{{osdu}}.centralus.cloudapp.azure.com/api/rafs ddms/v1/CCE/get_CCE_data_record_id/45'
        ],
        title='Differential Liberation Test Measurements',
    )
    ...
    Remarks: Optional[List[Remark]] = Field(
        None,
        description='An array containing operational or quality comments pertaining to a differential liberation analysis.',
    ...
    FluidSampleID: Optional[
        ...
        None,
        description='Unique ID of the FLuid Which was analyzed on differential liberation',
...
class DifferentialLiberationTest(BaseModel):
    ...
    kind: constr(regex=r'^[\w\-\.]+:[\w\-\.]+:[\w\-\.]+:[0-9]+.[0-9]+.[0-9]+$') = Field(
        ...
        example='rafsddms:wks:work-product-component--DifferentialLiberationTest:1.0.0',
        title='Entity Kind',
    )
    ...
    id: constr(
        regex=r'^[\w\-\.]+:work-product-component\-\-DifferentialLiberationTest:[\w\-\.\:\%]+$'
    ) = Field(
        ...,
        description='Previously called ResourceID or SRN which identifies this OSDU resource object without version.',
        example='namespace:work-product-component--DifferentialLiberationTest:dd76cf6c-226f-5636-ad1b-1ca0f8249cc8',
        title='DifferentialLiberationTest',
    )
