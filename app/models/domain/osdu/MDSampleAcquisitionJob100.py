...
from .osdu_wks_AbstractProject_1.field_0 import Field0 as Field0_2
from .osdu_wks_AbstractProjectActivity_1.field_2 import Field0 as Field0_3


class Data(Field0, Field0_1, Field0_2, Field0_3):
    JobTypeID: Optional[str] = Field(
        None,
        description="Free form text to specify the type of the sample acquisition job",
        title="Job Type ID",
    )
    ReferenceJobNumber: Optional[str] = Field(
        None,
...
class SampleAcquisitionJob(BaseModel):
    class Config:
        extra = Extra.forbid
    ...
    id: Optional[
        constr(regex=r"^[\w\-\.]+:master-data\-\-SampleAcquisitionJob:[\w\-\.\:\%]+$")
    ] = Field(
        None,
