...
#   filename:  api/schema-service/v1/schema/rafsddms:wks:work-product-component--WaterAnalysisTest:1.0.0
#   timestamp: 2023-05-02T15:27:30+00:00
...
class WaterAnalysisTest(BaseModel):
    class Config:
        extra = Extra.forbid
    ...
    kind: constr(regex=r'^[\w\-\.]+:[\w\-\.]+:[\w\-\.]+:[0-9]+.[0-9]+.[0-9]+$') = Field(
        ...
        example='rafsddms:wks:work-product-component--WaterAnalysisTest:1.0.0',
        title='Entity Kind',
    )
