...
class CoordinateModel(Coordinate):
    pass
...
class GeometryItemModel1(BaseModel):
    coordinates: List[List[CoordinateModel]]
    type: TypeModel1
    bbox: Optional[List[float]] = Field(None, min_items=4)
...
class CoordinateModel1(Coordinate):
    pass
...
class GeometryItemModel3(BaseModel):
    coordinates: List[List[CoordinateModel1]]
    type: TypeModel3
    bbox: Optional[List[float]] = Field(None, min_items=4)


class CoordinateModel2(Coordinate):
    pass
...
class GeometryItemModel4(BaseModel):
    coordinates: List[List[List[CoordinateModel2]]]
    type: TypeModel4
    bbox: Optional[List[float]] = Field(None, min_items=4)
...
class CoordinateModel3(Coordinate):
    pass


class GeometryModel(BaseModel):
    coordinates: List[CoordinateModel3] = Field(..., min_items=2)
    type: TypeModel
    bbox: Optional[List[float]] = Field(None, min_items=4)


class CoordinateModel4(Coordinate):
    pass


class GeometryModel1(BaseModel):
    coordinates: List[List[CoordinateModel4]]
    type: TypeModel1
    bbox: Optional[List[float]] = Field(None, min_items=4)


class GeometryModel2(BaseModel):
    coordinates: List[List[float]]
    type: TypeModel2
    bbox: Optional[List[float]] = Field(None, min_items=4)


class CoordinateModel5(Coordinate):
    pass


class GeometryModel3(BaseModel):
    coordinates: List[List[CoordinateModel5]]
    type: TypeModel3
    bbox: Optional[List[float]] = Field(None, min_items=4)


class CoordinateModel6(Coordinate):
    pass


class GeometryModel4(BaseModel):
    coordinates: List[List[List[CoordinateModel6]]]
    type: TypeModel4
    bbox: Optional[List[float]] = Field(None, min_items=4)
