...
#   filename:  api/schema-service/v1/schema/osdu:wks:master-data--GenericSite:1.0.0
#   timestamp: 2023-12-12T16:47:45+00:00
...
class Data(Field0, Field0_1):
    Remarks: Optional[List[field_0.Field0]] = Field(
        None, description="An array of remarks.", title="Remarks"
    )
    Name: Optional[str] = Field(
        None, description="The name of this generic site.", title="Name"
    )
    SiteTypeID: Optional[
        constr(regex=r"^[\w\-\.]+:reference-data\-\-SiteType:[\w\-\.\:\%]+:[0-9]*$")
    ] = Field(None, description="The classification of the site.", title="Site Type ID")
    ExtensionProperties: Optional[Dict[str, Any]] = None


class GenericSite(BaseModel):
    class Config:
        extra = Extra.forbid
    ...
    kind: constr(regex=r"^[\w\-\.]+:[\w\-\.]+:[\w\-\.]+:[0-9]+.[0-9]+.[0-9]+$") = Field(
        ...
        example="osdu:wks:master-data--GenericSite:1.0.0",
        title="Entity Kind",
    )
    ...
    id: Optional[
        constr(regex=r"^[\w\-\.]+:master-data\-\-GenericSite:[\w\-\.\:\%]+$")
    ] = Field(
        None,
        description="Previously called ResourceID or SRN which identifies this OSDU resource object without version.",
        example="namespace:master-data--GenericSite:3f105abc-fa42-5088-b498-a5fc743a6d21",
        title="Entity ID",
    )
