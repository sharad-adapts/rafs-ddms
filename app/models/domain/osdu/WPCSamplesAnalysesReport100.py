...
#   filename:  /api/schema-service/v1/schema/exxonmobil:rafsddms:work-product-component--SamplesAnalysesReport:1.0.0
#   timestamp: 2023-06-15T18:26:06+00:00
...
class Data(Field0, Field0_1, Field0_2):
    ...
    LaboratoryIDs: Optional[List[str]] = Field(
        None,
    ...
    SampleIDs: Optional[
        ...
        example=[
            'namespace:master-data--Sample:dd76cf6c-226f-5636-ad1b-1ca0f8249cc8'
        ],
        title='Sample IDs',
    )
    ...
    DatePublished: Optional[datetime] = Field(
        None, description='The UTC date time and date of the document publication'
    )
    LaboratoryNames: Optional[List[str]] = Field(
        ...
        title='Laboratory Names',
    )
    Remarks: Optional[List[Remark]] = Field(
        None,
        description='An array containing operational or quality comments pertaining to a SamplesAnalysesReport.',
    ...
    ReportSampleIdentifiers: Optional[List[str]] = Field(
        ...
        title='Report Sample Identifiers',
    )
    SamplesAnalysisCategoryTagIDs: Optional[List[str]] = Field(
        None,
    ...
    SampleAnalysisTypeIDs: Optional[List[str]] = Field(
        None,
        ...
        title='Sample Analysis Type IDs',
    )
...
class SamplesAnalysesReport(BaseModel):
    ...
    kind: constr(regex=r'^exxonmobil:rafsddms:[\w\-\.]+:[0-9]+.[0-9]+.[0-9]+$') = Field(
        ...,
        description='The schema identification for the OSDU resource object following the pattern {Namespace}:{Source}:{Type}:{VersionMajor}.{VersionMinor}.{VersionPatch}. The versioning scheme follows the semantic versioning, https://semver.org/.',
        example='exxonmobil:rafsddms:work-product-component--SamplesAnalysesReport:1.0.0',
        title='Entity Kind',
    )
    ...
    id: Optional[
        ...
        example='namespace:work-product-component--SamplesAnalysesReport:dd76cf6c-226f-5636-ad1b-1ca0f8249cc8',
        title='Entity ID',
    )
