...
class Field0ItemModel(BaseModel):
...
class Field0ItemModel1(BaseModel):
    persistableReference: str = Field(
        ...,
...
class Field0ItemModel2(BaseModel):
    persistableReference: str = Field(
        ...,
...
class Field0(BaseModel):
    __root__: Union[
        Field0Item, Field0ItemModel, Field0ItemModel1, Field0ItemModel2
    ] = Field(
        ...,
