...
#   timestamp: 2023-07-28T13:47:32+00:00
...
class ResinsWeightFraction(FlashFromPressure):
    pass


class SaturateWeightFraction(FlashFromPressure):
    pass
...
class SARAItem(BaseModel):
    ...
    ResinsWeightFraction: Optional[ResinsWeightFraction] = None
    SaturateWeightFraction: Optional[SaturateWeightFraction] = None
