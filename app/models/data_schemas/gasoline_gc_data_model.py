...
#   filename:  gasoline_gc_data_schema.json
#   timestamp: 2023-09-12T18:31:18+00:00
...
class GasolineDatum(BaseModel):
    CompoundCode: Optional[
        constr(
            regex=r"^[\w\-\.]+:reference-data\-\-GasolineCompounds:[\w\-\.\:\%]+:[0-9]*$"
        )
    ] = None
...
class Model(BaseModel):
    ...
    GasolineData: Optional[List[GasolineDatum]] = Field(
        None, description="The gas chromatography gasoline analysis", title="Gasoline"
    )
