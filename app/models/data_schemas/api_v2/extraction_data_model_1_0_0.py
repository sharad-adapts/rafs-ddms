...
#   timestamp: 2025-02-11T20:51:05+00:00
...
class ExtractionModel100(RafsBaseModel):
    ...
    MassOfSampleExtracted: Optional[float] = Field(
        None,
        description="The mass of the sample that has been submitted for extraction. note - may be a fraction of a whole rock sample.",
        title="Mass Of Sample Extracted",
    )
    MassOfExtract: Optional[float] = Field(
        None,
        description="The mass of fluid extract obtained from the extraction sample.",
        title="Mass Of Extract",
    )
    ExtractYield: Optional[float] = Field(
        None,
        description="The extract yield: mass of extract / mass of parent sample.  This is calculated but can sometimes be provided in lieu of the actual mass of extract and mass of parent sample values.",
        title="Extract Yield",
    )
    ExtractOfTotalOrganicCarbon: Optional[float] = Field(
        None,
        description="The mass of extract as a percentage of Total Organic Carbon (TOC).  This is calculated based on Total Organic Carbon provided in Pyrolysis data, but can sometimes be provided in lieu of the actual mass of extract and TOC values.",
        title="Extract Of Total Organic Carbon",
    )
    Remarks: Optional[List[Remark]] = Field(None, title="Remarks")
