...
#   filename:  pdp.1.0.0.json
#   timestamp: 2025-02-11T23:23:43+00:00
...
class PdpModel100(RafsBaseModel):
    class Config:
        extra = Extra.forbid
    ...
    PDPSteps: Optional[List[PDPStep]] = Field(
        None,
        description="This is the object containing the individual pressure steps of this analysis.",
        title="PDP Steps",
    )
    GammaDrawdown: Optional[float] = Field(
        None,
        description="Coefficient (gamma) is used as a parameter in pressure vs permeability modeling to adjust fit of a drawdown curve.",
        title="Gamma Drawdown",
    )
    GammaBuildUp: Optional[float] = Field(
        None,
        description="Coefficient (gamma) is used as a parameter in pressure vs permeability modeling to adjust fit of a buildup curve.",
        title="Gamma Build Up",
    )
    Log10GammaDrawdown: Optional[float] = Field(
        None,
        description="Expressed in Log10, coefficient (gamma) is used as a parameter in pressure vs permeability modeling to adjust fit of a drawdown curve.",
        title="Log10 Gamma Drawdown",
    )
    Log10GammaBuildUp: Optional[float] = Field(
        None,
        description="Expressed in Log10, coefficient (gamma) is used as a parameter in pressure vs permeability modeling to adjust fit of a buildup curve.",
        title="Log10 Gamma Build Up",
    )
    Formation: Optional[str] = Field(
        None,
        description="The name of a distinct layer of rock with specific characteristics and a defined stratigraphic boundary in which this analysis is focused.",
        title="Formation",
    )
