...
#   timestamp: 2024-12-02T18:44:13+00:00
...
class RelativePermeability(RafsBaseModel):
    ...
    RelativePermeabilityTypeID: Optional[
        constr(
            regex=r"^[\w\-\.]+:reference-data\-\-PermeabilityMeasurementType:[\w\-\.\:\%]+:[0-9]*$"
        )
    ] = Field(
        None,
        description="The type of relative permeability.",
        title="Relative PermeabilityType ID",
    )
    Value: Optional[float] = Field(
    ...
    FluidTypeID: Optional[
        ...
        None,
        description="The fluid type used in determining relative permeability.",
        title="Fluid Type ID",
    )
