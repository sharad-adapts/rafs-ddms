...
#   filename:  rock_compressibility.1.0.0.json
#   timestamp: 2025-02-11T23:38:48+00:00
...
class CompressibilityItem(RafsBaseModel):
    ...
    CompressibilityMeasurementTypeID: Optional[
        constr(
            regex=r"^[\w\-\.]+:reference-data\-\-CompressibilityMeasurementType:[\w\-\.\:\%]+:[0-9]*$"
        )
    ] = Field(
        None,
        description="Identifies the type of compression applied to the sample, e.g. hydrostatic, uniaxial.",
        title="Compressibility Measurement Type ID",
    )
...
class CompressibilityTestStep(RafsBaseModel):
    ...
    ConfiningStress: Optional[float] = Field(
        None,
        description="Confining stress is the stress that a rock mass experiences due to the surrounding rock and overburden. This stress plays a significant role in determining how rocks fracture and fail under various conditions.",
        title="Confining Stress",
    )
    ...
    Compressibility: Optional[List[CompressibilityItem]] = Field(
        None,
        description="Compressibility is a measure of how much a substance can be compressed under pressure.",
...
class RockCompressibilityModel100(RafsBaseModel):
    class Config:
        extra = Extra.forbid
    ...
    CompressibilityTestSteps: Optional[List[CompressibilityTestStep]] = Field(
        None,
        description="The test steps for this sample experiment.",
        title="Compressibility Test Steps",
    )
