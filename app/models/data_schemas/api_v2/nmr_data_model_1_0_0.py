...
#   filename:  nmr.1.0.0.json
#   timestamp: 2025-02-13T02:46:49+00:00
...
class CumulativePorosity(RafsBaseModel):
    ...
    Value: Optional[float] = Field(
        None, description="The porosity value of the sample.", title="Value"
    )
...
class IncrementalPorosity(RafsBaseModel):
    ...
    Value: Optional[float] = Field(
        None, description="The porosity value.", title="Value"
    )
    PorosityMeasurementTypeID: Optional[
        constr(
            regex=r"^[\w\-\.]+:reference-data\-\-PorosityMeasurementType:[\w\-\.\:\%]+:[0-9]*$"
...
class NMRTestStep(RafsBaseModel):
    ...
    CumulativeWaterSaturation: Optional[float] = Field(
        None,
        description="Cumulative water saturation",
        title="Cumulative Water Saturation",
    )
    CumulativeVolume: Optional[float] = Field(
        None,
    ...
    IncrementalWaterSaturation: Optional[float] = Field(
        None,
...
class NMRSummaryData(RafsBaseModel):
    ...
    T2CutOff: Optional[float] = Field(
        None,
        description="Cut off of transverse relaxation time (T2).",
        title="T2 Cut Off",
    )
    T2Mean: Optional[float] = Field(
        None, description="Average of T2 relaxation time.", title="T2 Mean"
    )
    ...
    PoreVolume: Optional[float] = Field(
        None, description="The pore volume of the sample.", title="Pore Volume"
    )
...
class NMRTestItem(RafsBaseModel):
    ...
    NMRSummaryData: Optional[NMRSummaryData] = Field(
        None,
...
class NmrModel100(RafsBaseModel):
    class Config:
        extra = Extra.forbid
    ...
    NMRTest: Optional[List[NMRTestItem]] = Field(
        None,
