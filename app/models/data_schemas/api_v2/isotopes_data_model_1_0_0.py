...
#   timestamp: 2025-02-13T15:22:17+00:00
...
class IsotopeRatioItem(RafsBaseModel):
    ...
    Value: Optional[float] = Field(
        None, description="Value of the Isotope ratio.", title="Value"
    )
...
class IsotopeAnalysisDatum(RafsBaseModel):
    ...
    ComponentID: Optional[
        constr(
            regex=r"^[\w\-\.]+:(reference-data\-\-GasIsotopeComponents|reference-data\-\-NonGasIsotopeComponents|reference-data\-\-CompoundSpecificIsotopeComponents):[\w\-\.\:\%]+:[0-9]*$"
        )
    ] = Field(
        None,
