...
#   timestamp: 2025-02-13T02:03:42+00:00
...
class MultipleContactMiscibilityModel100(RafsBaseModel):
    ...
    TestTemperature: Optional[float] = Field(
        None,
        description="The temperature at which the test is conducted, which can influence the behavior of gases and the results of the analysis.",
        title="Test Temperature",
    )
    TypeOfInjectedGas: Optional[str] = Field(
        None,
        description="The type of gas injected into the sample.",
        title="Type Of Injected Gas",
    )
    TypeOfMultiContactTest: Optional[str] = Field(
        None,
        description="The type of multiple contact test.",
        title="Type Of Multi Contact Test",
    )
    MolePercentOfInjectedGas: Optional[float] = Field(
        None,
        description="The mole percentage of the injected gas in the mixture, representing its proportion relative to the total gas composition.",
        title="Mole Percent Of Injected Gas",
    )
    GasSolventCompositionReference: Optional[str] = Field(
        None,
        description="Gas solvent composition reference.",
        title="Gas Solvent Composition Reference",
    )
    MixRatio: Optional[float] = Field(
        None, description="The mix ratio.", title="Mix Ratio"
    )
