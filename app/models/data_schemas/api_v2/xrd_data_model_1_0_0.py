...
#   timestamp: 2025-02-12T17:51:16+00:00
...
class MineralContentItem(RafsBaseModel):
    ...
    MineralID: Optional[
        ...
        None,
        description="The mineral identified in the XRD analysis.",
        title="Mineral ID",
    )
    WeightPercent: Optional[float] = Field(
        None,
        description="The amount or concentration of the identified mineral in the sample, reported as a percentage of weight.",
        title="Weight Percent",
    )
    VolumePercent: Optional[float] = Field(
        None,
        description="The amount or concentration of the identified mineral in the sample, reported as a percentage of volume.",
...
class XrdModel100(RafsBaseModel):
    ...
    QuartzCrystallinityIndex: Optional[float] = Field(
        None,
        description="Measure of the degree of crystallinity of quartz in a sample, indicating the relative quality of the crystal structure as determined by X-ray diffraction (XRD) analysis.",
        title="Quartz Crystallinity Index",
    )
    MineralContent: Optional[List[MineralContentItem]] = Field(
        None,
        description="An array of objects recording the mineral content in a rock sample determined by X-ray Diffraction.",
