...
#   filename:  interfacial_tension.1.0.0.json
#   timestamp: 2025-02-10T14:17:15+00:00
...
class Surfactant(RafsBaseModel):
    ...
    SurfactantName: Optional[str] = Field(
        None,
...
class TestStep(RafsBaseModel):
    ...
    WettingPhaseSaturation: Optional[float] = Field(
        None,
    ...
    SurfactantConcentration: Optional[float] = Field(
        None,
...
class InterfacialTensionModel100(RafsBaseModel):
    class Config:
        extra = Extra.forbid
    ...
    NonWettingPhaseTypeID: Optional[
        constr(
            regex=r"^[\w\-\.]+:reference-data\-\-WettabilityPhaseType:[\w\-\.\:\%]+:[0-9]*$"
        )
    ] = Field(
    ...
    Surfactants: Optional[List[Surfactant]] = Field(
        None,
