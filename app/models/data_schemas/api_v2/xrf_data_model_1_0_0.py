...
#   filename:  xrf.1.0.0.json
#   timestamp: 2025-02-12T18:00:21+00:00
...
class ElementalCompositionItem(RafsBaseModel):
    ...
    ElementID: Optional[
        ...
        None,
        description="The chemical element identified in the XRF analysis.",
        title="Element ID",
    )
    Content: Optional[float] = Field(
        None,
        description="The quantified amount or concentration of the identified element in the sample.",
        title="Content",
    )


class XrfModel100(RafsBaseModel):
    class Config:
        extra = Extra.forbid
    ...
    ElementalComposition: Optional[List[ElementalCompositionItem]] = Field(
        None,
        description="The elemental composition of the sample determined by X-ray Fluorescence XRF",
