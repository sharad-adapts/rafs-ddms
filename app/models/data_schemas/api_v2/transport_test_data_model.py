...
#   timestamp: 2024-09-11T19:20:01+00:00
...
class ViscosityTestStep(RafsBaseModel):
    class Config:
        extra = Extra.forbid
...
class TransportTestDataSchema(RafsBaseModel):
    class Config:
        extra = Extra.forbid
    ...
    ViscosityTestSteps: Optional[List[ViscosityTestStep]] = None
