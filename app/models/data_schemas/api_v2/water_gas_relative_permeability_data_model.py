...
#   filename:  water_gas_relative_permeability_data_schema.json
#   timestamp: 2023-11-22T19:43:05+00:00
...
class InitialCondition(RafsBaseModel):
    class Config:
        extra = Extra.forbid
...
class PctOfOriginalGasInPlace(RafsBaseModel):
    class Config:
        extra = Extra.forbid
...
class PctOfInitialGasInPlace(RafsBaseModel):
    class Config:
        extra = Extra.forbid
...
class TerminalCondition(RafsBaseModel):
    class Config:
        extra = Extra.forbid
