...
#   filename:  eds_mapping.1.0.0.json
#   timestamp: 2025-02-13T03:08:17+00:00
...
class PeakPosition(RafsBaseModel):
    ...
    XCoordinate: Optional[float] = Field(
        None,
        description="The horizontal position on the thin section surface where the EDS measurement is taken.",
        title="X Coordinate",
    )
    YCoordinate: Optional[float] = Field(
        None,
        description="The vertical position on the thin section surface corresponding to the location of the EDS measurement.",
        title="Y Coordinate",
    )
...
class Concentration(RafsBaseModel):
    ...
    PeakPosition: Optional[PeakPosition] = Field(
        None,
        description="The energy level where the characteristic X-ray peak for a particular element occurs, used for element identification.",
        title="Peak Position",
    )
...
class ElementalCompositionItem(RafsBaseModel):
    ...
    ElementID: Optional[
        ...
        None,
        description="The specific chemical element identified at a given location on the thin section.",
        title="Element ID",
    )
    Concentration: Optional[Concentration] = Field(
        None,
        description="The percentage or amount of the detected element present in the sample, expressed in weight or atomic percent.",
        title="Concentration",
    )


class EdsMappingModel100(RafsBaseModel):
    class Config:
        extra = Extra.forbid
    ...
    ElementalComposition: Optional[List[ElementalCompositionItem]] = Field(
        None,
        description="The overall distribution and abundance of elements detected on the surface of the thin section during EDS mapping.",
