...
#   timestamp: 2025-02-13T01:14:58+00:00
...
class CoreGammaDatum(RafsBaseModel):
    ...
    Depth: float = Field(
        ...,
        description="The depth of this sampling point, typically reported relative to the depth of extracted core.",
        title="Depth",
    )
    Uranium: Optional[float] = Field(
        None,
        description="The amount of gamma radiation as a result of Uranium decay.",
        title="Uranium",
    )
    Thorium: Optional[float] = Field(
        None,
        description="The amount of gamma radiation as a result of Thorium decay.",
        title="Thorium",
    )
    Potassium: Optional[float] = Field(
        None,
        description="The amount of gamma radiation as a result of Potassium decay.",
        title="Potassium",
    )
    TotalGamma: Optional[float] = Field(
        None,
...
class CoreGammaModel100(RafsBaseModel):
    ...
    CoreGammaData: Optional[List[CoreGammaDatum]] = Field(
        None,
        description="Array object containing the individual depth-aligned measurements of this analysis.",
        title="Core Gamma Data",
    )
