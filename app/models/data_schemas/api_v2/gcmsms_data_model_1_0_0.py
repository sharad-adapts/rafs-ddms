...
#   filename:  gcmsms.1.0.0.json
#   timestamp: 2025-02-13T03:31:47+00:00
...
class GasChromatographyTandemMassSpectrometryAnalysi(RafsBaseModel):
    ...
    RetentionTime: Optional[float] = Field(
        None,
        description="The time it takes for a compound to pass through the GC column and be detected by the mass spectrometer, indicative of its interaction with the stationary phase.",
        title="Retention Time",
    )
    Ions: Optional[List[str]] = Field(
        None,
        description="The specific charged particles (ions) detected in the mass spectrometer, which help in identifying the molecular structure of the compound.",
        title="Ions",
    )
    ...
    Type: Optional[constr(regex=r"^[\w\-\.]+:\-\-:[\w\-\.\:\%]+:[0-9]*$")] = Field(
        None,
        description="Identifiies whether the compound is from the sample or part of the standard.",
        example="",
        title="Type",
    )
...
class StandardCompoundItem(RafsBaseModel):
    ...
    Peak: Optional[List[PeakItem]] = Field(
        None,
...
class GcmsmsModel100(RafsBaseModel):
    class Config:
        extra = Extra.forbid
