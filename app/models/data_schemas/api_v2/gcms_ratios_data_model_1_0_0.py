...
#   timestamp: 2025-02-13T03:56:38+00:00
...
class GCMSCompoundsRatio(RafsBaseModel):
    ...
    GCMSCompoundRatioID: Optional[
        constr(
            regex=r"^[\w\-\.]+:reference-data\-\-GCMSCompoundsRatios:[\w\-\.\:\%]+:[0-9]*$"
        )
    ] = Field(
        None,
        description="Specific identifier associated with the type of compound ratio being measured, such as the ratio between two key hydrocarbons, which helps in standardizing and categorizing the data for analysis.",
        title="GCMS Compound Ratio ID",
    )
    Ratio: Optional[List[RatioItem]] = Field(
        None,
        description="Quantifies the proportion between the concentrations of two specific compounds identified in the sample, providing insights into the compositional characteristics and potential origins of the hydrocarbons present.",
        title="Ratio",
    )
...
class GcmsRatiosModel100(RafsBaseModel):
    ...
    GCMSCompoundsRatios: Optional[List[GCMSCompoundsRatio]] = Field(
        ...
        title="Gas Chromatography Mass Spectrometry Compounds Ratios",
    )
