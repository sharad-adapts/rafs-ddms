...
#   filename:  fractionation.1.0.0.json
#   timestamp: 2025-02-06T13:52:42+00:00
...
class FractionAbundanceItem(RafsBaseModel):
    class Config:
        extra = Extra.forbid

    ComponentID: Optional[
        constr(
            regex=r"^[\w\-\.]+:reference-data\-\-FractionationComponent:[\w\-\.\:\%]+:[0-9]*$"
        )
    ] = Field(
        None,
        description="Identifies the fractionation component being measured.",
        title="Component ID",
    )
    MassFraction: Optional[float] = Field(
        None,
        description="The concentration of the fractionation component as a mass proportion.",
        title="Mass Fraction",
    )
    Mass: Optional[float] = Field(
        None, description="The mass of the fractionation component.", title="Mass"
    )
...
class FractionationModel100(RafsBaseModel):
    class Config:
        extra = Extra.forbid
    ...
    FractionationMethodIDs: Optional[
        List[
            constr(
                regex=r"^[\w\-\.]+:reference-data\-\-FractionationMethod:[\w\-\.\:\%]+:[0-9]*$"
            )
        ]
    ] = Field(
        None,
        description="The specific techniques or procedures used to separate the petroleum fractions, such as distillation or SARA analysis.  In some instances multiple methods may be used.",
        title="Fractionation Method IDs",
    )
    FractionationSum: Optional[float] = Field(
        None,
        description="The total percentage of all fractions obtained from the sample after the fractionation process.",
        title="Fractionation Sum",
    )
    TotalFluidInitialMass: Optional[float] = Field(
        None,
        description="The initial mass of the fluid before any fractionation or processing occurs.",
        title="Total Fluid Initial Mass",
    )
    TotalFluidMassAfterTopping: Optional[float] = Field(
        None,
        description="The mass of the fluid remaining after the topping process, which removes lighter fractions.",
        title="Total Fluid Mass After Topping",
    )
    MassOfLoadedAmount: Optional[float] = Field(
        None,
        description="The mass of the fluid sample loaded for fractionation.  This is commonly measured on the soluble components after asphaltene precipitation.",
        title="Mass Of Loaded Amount",
    )
    RecoveryMass: Optional[float] = Field(
        None,
        description="The mass of the sample recovered after the fractionation process.",
        title="Recovery Mass",
    )
    LossMass: Optional[float] = Field(
        None,
        description="The total mass of the sample lost during fractionation.",
        title="Loss Mass",
    )
    FractionAbundance: Optional[List[FractionAbundanceItem]] = Field(
        None,
        description="The abundance of components measured using fractionation.",
        title="Fraction Abundance",
    )
    FractionNormalisation: Optional[str] = Field(
        None,
        description="A description of the process used to normalise the Fraction Abundance.  If this is populated, IsNormalised should also be set.",
        title="Fraction Normalisation",
    )
    IsNormalised: Optional[bool] = Field(
        None,
        description="Specifies whether the Fraction Abundance array object values have been normalised as described in FractionNormalisation.",
        title="IsNormalised",
    )
