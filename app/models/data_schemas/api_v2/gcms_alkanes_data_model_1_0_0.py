...
#   filename:  gcms_alkanes.1.0.0.json
#   timestamp: 2025-02-12T21:38:39+00:00
...
class SaturateGCMSCompound(RafsBaseModel):
    ...
    CompoundID: Optional[
        ...
        None,
        description="A unique identifier or code assigned to each compound detected in the GC-MS analysis.",
        title="Compound ID",
    )
...
class StandardCompoundItem(RafsBaseModel):
    ...
    RetentionTime: Optional[float] = Field(
        None,
        description="The time it takes for the standard compound to pass through the GC column and be detected, providing a reference point for comparing other compounds.",
        title="Retention Time",
    )
    Ion: Optional[str] = Field(
        None,
...
class GcmsAlkanesModel100(RafsBaseModel):
    class Config:
        extra = Extra.forbid
    ...
    SaturateGCMSCompounds: Optional[List[SaturateGCMSCompound]] = Field(
        None,
        description="The list of compounds in Saturate Gas Chromatography Mass Spectrometry (GCMS) analysis. Saturates include alkanes.",
        title="Saturate GCMS Compounds",
    )
