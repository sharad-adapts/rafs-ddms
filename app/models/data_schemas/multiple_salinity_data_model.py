...
#   timestamp: 2023-07-31T20:13:43+00:00
...
class SalinityTestResult(BaseModel):
    SampleID: Optional[
...
class BrineConductivity(BaseModel):
    Value: Optional[float] = None
    UnitOfMeasure: Optional[
        constr(
            regex=r'^[\w\-\.]+:reference-data\-\-UnitOfMeasure:[\w\-\.\:\%]+:[0-9]*$'
...
class CoreConductivity(BaseModel):
    Value: Optional[float] = None
    UnitOfMeasure: Optional[
        constr(
            regex=r'^[\w\-\.]+:reference-data\-\-UnitOfMeasure:[\w\-\.\:\%]+:[0-9]*$'
...
class SalinityTestStep(BaseModel):
